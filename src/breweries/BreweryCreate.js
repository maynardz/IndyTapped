        ...
        return (
            <div>
                ...
                <Form onSubmit={this.handleSubmit} >
                    <FormGroup>
                        <Input id="brewery" type="select" name="brewery" value={this.state.Brewery} onChange={this.handleChange} >
                    ...
                    <FormGroup>
                        <Input type="select" name="rating" id="rating" value={this.state.Rating} onChange={this.handleChange} >
